...
export interface ThumbnailPublishOutcomeV1 { lotUid: string; status: 'ok'; srcPath: string; previousSrcPath?: string | null; imageUrl: string; thumbUrl: string; verifiedAt: string; width?: number; height?: number; contentType?: string; sizeBytes?: number; hash?: string; ordinal?: number | null; reused?: boolean; }
